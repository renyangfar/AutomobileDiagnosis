...
{  
	...
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource2,GPIO_AF_USART2); //GPIOB11复用为USART2
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource3,GPIO_AF_USART2); //GPIOB10复用为USART2	
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2 | GPIO_Pin_3; //GPIOB11和GPIOB10初始化
	...
	TIM6_Int_Init(1000-1,8400-1);		//100ms中断
	//USART2_RX_STA=0;		//清零
